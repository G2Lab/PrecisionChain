...
def loadFilePaths(genePath, geneFiles):
    '''
    ...
    genePaths = []
    for file in files:
        variantPath = '/gpfs/commons/datasets/1000genomes/hg38/ALL.chr{}.phase3_shapeit2_mvncall_integrated_v3plus_nounphased.rsID.genotypes.GRCh38_dbSNP_no_SVs.vcf.gz'.format(file)
        variantPaths.append(variantPath)
...
def main():
    ...
    try:
        ...
        paths = loadFilePaths(args.genepaths, args.chromosomes)
